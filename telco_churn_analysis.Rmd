...
#### Problem
* Customer Churn is a metric used by subscripton-based businesses to measure the number of customers lost in a given amount of time. 

* MRR Churn is a widely-used financial metric that calculates the amount of monthly recurring revenue (MRR) lost each month due to customer cancellations. 

* As a subscripton-based business's survival depends on recurring revenue, churn reduction is an essential growth KPIs. 

#### Proposal
* In order to mitigate churn, it's important to identify which factors correlate to a higher likelihood to churn. 
...
* [Payment_Features Data Frame](#D3)
* [Demographic Features Data Frame](#D4)
* [Adoption Features Data Frame](#D4)
...
payment_features <- payment_dummy %>% 
  bind_cols(contract_dummy,churndf)
...
glimpse(Internet_dummy)

glimpse(telco$InternetService)
...
# Plots the telco1 data drame with the get_cor function
payment_features %>%
